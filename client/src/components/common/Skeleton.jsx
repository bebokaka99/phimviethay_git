...
export const HomeSkeleton = () => {
  return (
    <div className="min-h-screen bg-[#0a0a0a] overflow-hidden">
      ...
      {/* Dùng RowSkeleton ở dưới đây hoặc giữ nguyên map cũ đều được, nhưng HomeSkeleton thường load full trang */}
...
// [THÊM MỚI] 6. Skeleton cho Lazy Load Row (Sửa lỗi Home.jsx import thiếu)
export const RowSkeleton = () => {
  return (
    <div className="mb-8 px-4 md:px-16 animate-pulse">
        {/* Tiêu đề hàng */}
        <div className="flex justify-between mb-4">
             <Skeleton className="h-6 w-48" />
             <Skeleton className="h-5 w-20" />
        </div>
        {/* Danh sách Card ngang */}
