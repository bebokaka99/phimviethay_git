                ...
                <div key={cmt.id} className="bg-[#161616] p-4 rounded-xl border border-white/5 flex gap-4 hover:border-white/20 transition shadow-lg">
                    ...
                    <div className="flex-1">
                        <div className="flex flex-wrap items-center gap-2 mb-1">
                            ...
                            {/* Link dẫn tới phim để Admin kiểm tra */}
                        ...
                        <div className="bg-black/40 p-3 rounded-lg border border-white/5 text-sm text-gray-300">
                            {cmt.content}
                        </div>
                        ...
                        {cmt.episode_slug && (
                            <div className="mt-1 flex justify-end">
                                <span className="text-[10px] text-gray-500 bg-white/5 px-2 rounded">Tập: {cmt.episode_slug}</span>
                            </div>
                        )}
                    </div>
                    ...
                    <button 
                        ...
                        className="self-center text-gray-500 hover:text-red-500 hover:bg-red-500/10 p-3 rounded-full transition"
